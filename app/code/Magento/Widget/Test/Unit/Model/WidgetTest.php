...
class WidgetTest extends TestCase
{
    ...
    public function testGetWidgetsWithFilter()
    {
        ...
        $this->dataStorageMock->expects($this->once())
            ->method('get')
            ->willReturn($widgets);
        $result = $this->widget->getWidgets(['name' => 'CMS Movie Account', 'description' => 'Account to a CMS Movie']);
    ...
    public function testGetConfigAsObject()
    {
        ...
        $this->assertSame('CMS Movie Account', $resultObject->getName());
        $this->assertSame('Account to a CMS Movie', $resultObject->getDescription());
