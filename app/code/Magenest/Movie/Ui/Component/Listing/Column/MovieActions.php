...
{
    /** Url path */
    const MOVIE_URL_PATH_EDIT = 'magenest_movie/movie/edit';
    const MOVIE_URL_PATH_DELETE = 'magenest_movie/movie/delete';

    /**
     * @var \Magenest\Movie\Block\Adminhtml\Movie\Grid\Renderer\Action\UrlBuilder
     */
