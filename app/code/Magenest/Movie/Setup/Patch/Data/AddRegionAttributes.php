...
class AddRegionAttributes implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(Customer::ENTITY, 'vn_region', [
            'type' => 'int',
            'input' => 'select',
            'label' => 'VN_Region',
            'required' => false,
            'source' => \Magenest\Movie\Model\Source\Region::class,
            'visible' => true,
            'user_defined' => true,
            'system' => false,
        ...
        $newAttribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'vn_region');
